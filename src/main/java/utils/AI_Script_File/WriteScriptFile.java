...
public class WriteScriptFile {
    ...
    public void writeTestScriptFile(TestCaseDTO testCaseDTO, String path){
        List<String> content = createTestScriptContext(testCaseDTO);
//        String testScriptPath = path + "src/test/java/" + parser.getTestSuiteName() + "/" + testCaseDTO.getName() + "Test.java";
        String testScriptPath = path + File.separator + "src"
                                + File.separator + "test"
                                + File.separator + "java" + File.separator + parser.getTestSuiteName() + File.separator
